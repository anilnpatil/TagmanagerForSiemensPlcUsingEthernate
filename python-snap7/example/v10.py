#this is fast writing and reading code for s7 1200 plc
import snap7
import struct
...
def insert_data_to_plc():
    try:
        ...
        for item in data_list:
            ...
            success = write_plc_value(plc, config['db'], config['offset'], config['dtype'], value, config.get('max_length'))
            results[tag] = {
        ...
        plc.disconnect()
        return jsonify({"message": "Write completed", "data": results}), 200
    ...
    try:
        ...
        for tag_name in requested_tags:
            if tag_name in TAG_CONFIG:
                ...
                # 👇 Only return the value directly (not data_type)
                results[tag_name] = value
            else:
                results[tag_name] = None  # or use {"error": "Tag not defined"} if needed
